...
def predict_chunk(train: pd.DataFrame) -> pd.DataFrame:
    ...
    model_0 = AutoModelForSequenceClassification.from_pretrained("/home/mcq/GitHub/aes2/topic-classificatio/output/fold_0/checkpoint-402")
    model_1 = AutoModelForSequenceClassification.from_pretrained("/home/mcq/GitHub/aes2/topic-classificatio/output/fold_1/checkpoint-402")


    # 加载分词器
    tokenizer = AutoTokenizer.from_pretrained("/home/mcq/GitHub/aes2/topic-classificatio/output/fold_0/checkpoint-402")
...
if __name__ == "__main__":
    ...
    submission_1.to_pickle('/home/mcq/GitHub/aes2/train_data/category-feat.pkl')
